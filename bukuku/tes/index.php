			...
			<?php foreach($buku as $b) : ?>
				...
				<div class="card mb-3">
  					<div class="row g-0">
  					  	...
  					  	<div class="col-md-8">
  					    	<div class="card-body">
  					    		<span class="position-absolute top-0 end-0 bg-dark text-white py-2 px-1 opacity-75"><small><?= $b['kategori'] ?></small></span>
  					    	  	...
  					    	  	<a href="hapus.php?id=<?= $b['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin?');">Hapus</a>		
  					    	</div>
  					  	</div>
				  	</div>
				</div>
